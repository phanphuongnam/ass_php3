...
<div class="register-box">
  <div class="register-logo">
    <a href="{{route('users.register')}}"><b>Admin</b>LTE</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="{{route('users.register-post')}}" method="post">
      ...
      <div class="form-group has-feedback">
       ...
       <div style="display:none;" class="form-group has-feedback">
        <input type="number"  value="0" class="form-control" placeholder="Active" id="is_active" name="is_active">
    ...
    <a href="{{route('users.getLogin')}}" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
